...
// Sets default values
ACreatureMonster::ACreatureMonster()                   //클래스 생성자
{
	...
	Movement->RotationRate = FRotator(0.0f, 700.0f, 0.0f);    //회전 속도
}
...
void ACreatureMonster::SetMovementSpeed(float NewSpeed)              //이동 속도 변경 로직
{
